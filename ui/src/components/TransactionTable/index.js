...
function createData(transaction) {
  return { date: transaction['date'], type: transaction['txn_type'], desc: transaction['description'],
  			mode: transaction['mode'],transfer: transaction['transfer'], debit: transaction['debit'], credit: transaction['credit'] };
}
...
const headCells = [
  ...
  { id: 'transfer', numeric: true, disablePadding: false, label: 'Transfer' },
...
export default function TransactionTable(props) {
	let rows = props.transactions.map((x)=>{
		return createData(x)
	})
	// const rows = [
